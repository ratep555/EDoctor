...
@Component({
  selector: 'app-doctors-list-patient',
  templateUrl: './doctors-list-patient.component.html',
  styleUrls: ['./doctors-list-patient.component.css']
})
export class DoctorsListPatientComponent implements OnInit {
  ...
  getDoctors() {
    ...
    this.doctorsService.getAllDoctorsOfPatient(this.userParams)
    .subscribe(response => {
